...
const file_pokemon_proto_rawDesc = "" +
	"\n" +
	"\rpokemon.proto\x12\apokemon\x1a\x1cgoogle/api/annotations.proto\"\x15\n" +
	"\x13ListPokemonsRequest\"-\n" +
	"\aPokemon\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x05R\x02id\"D\n" +
	"\x14ListPokemonsResponse\x12,\n" +
	"\bpokemons\x18\x01 \x03(\v2\x10.pokemon.PokemonR\bpokemons2s\n" +
	"\x0ePokemonService\x12a\n" +
	"\fListPokemons\x12\x1c.pokemon.ListPokemonsRequest\x1a\x1d.pokemon.ListPokemonsResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/pokemonsB.Z,github.com/gimmy/awesome-api/pokemon;pokemonb\x06proto3"
